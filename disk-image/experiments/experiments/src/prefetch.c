//
// Created by shixinsong on 10/4/23.
//
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
...
#define PAGE_ALIGN 0x200000
#define NUM_PAGES 512
#define TLB_SIZE 64
#define PAGE_SMALL 4096

char tlb_buffer[TLB_SIZE * PAGE_SMALL];
void flush_dtlb() {
    unsigned long i = 0;
    volatile char x;
    for (i = 0; i < TLB_SIZE; i++) {
        tlb_buffer[i * PAGE_SMALL] += i;
    }
}
