...
#define __M5_OP_INST(num, ...) __asm__ __volatile__ (__M5_OP_INST_ASM_STR(num) : : __VA_ARGS__ :)
...
// #define M5_INIT_PARAM_INST(key_str1, key_str2)              M5_OP_INST(M5OP_INIT_PARAM, "D" (key_str1), "S" (key_str2))
